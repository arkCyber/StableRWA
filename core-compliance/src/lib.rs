...
pub use types::{
    ComplianceStatus, ComplianceLevel, RiskLevel, JurisdictionCode,
    KycData, AmlCheck, ComplianceReport, AuditEvent, AmlResult, KycResult
};
pub use service::ComplianceService;
pub use kyc::{KycProvider, KycService};
pub use aml::{AmlProvider, AmlService};
...
pub struct ComplianceCheckResult {
    ...
    pub kyc_result: Option<kyc::KycResult>,
    pub aml_result: Option<aml::AmlResult>,
